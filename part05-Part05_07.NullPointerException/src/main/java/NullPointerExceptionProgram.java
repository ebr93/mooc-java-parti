...
public class NullPointerExceptionProgram {
    ...
    public static void main(String[] args) {
        ...
        //(null) has to be implemented right at the beginning since it works with (reference) variables
        //after applying it, there is nothing that (lines) refers back to. It is no longer an ArrayList
        //NULL VALUE TO A REFERENCE VARIABLE
        lines = null;
